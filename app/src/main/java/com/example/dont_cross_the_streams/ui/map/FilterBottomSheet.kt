...
fun FilterBottomSheet(
    ...
    ModalBottomSheet(
        ...
        Column(
            ...
            // Section 1: Conflict Region Presets
            Text(
            ...
            // Section 3: Barrier Types Filter
            Text(
...
fun FilterBottomSheetPreview() {
    DontcrossthestreamsTheme {
        Surface {
            FilterBottomSheet(
                selectedTaxonGroups = setOf("Mammals", "Fish"),
                selectedBarrierTypes = setOf(BarrierType.HIGHWAY, BarrierType.DAM),
                activePreset = ConflictRegionPreset.YELLOWSTONE_CORRIDOR,
                onToggleTaxonGroup = {},
                onToggleBarrierType = {},
                onSelectPreset = {},
                onResetFilters = {},
